...
describe('[Challenge] The rewarder', function () {
    ...
    it('Exploit', async function () {
        ...
        const AttackerFactory = await ethers.getContractFactory('Attacker5', attacker);
        this.attack = await AttackerFactory.deploy(
            this.rewarderPool.address, this.flashLoanPool.address,
            this.liquidityToken.address, this.rewardToken.address,
